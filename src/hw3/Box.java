...
public class Box implements Iterable<Ball> {
    ...
    public boolean add(Ball b) {
        // Your code goes here.  Remove the exception after you're done.
        if ((getVolume() + b.getVolume() <= maxVol) && !contains(b)) {
            ballContainer.add(b);
            return true;
        } else {
            return false;
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        ...
        Collections.sort(list, new compBall());
    ...
    /**
     * This is an inner class created to use interface 
     * Comparator.
     */
    public class compBall implements Comparator<Ball> {
        
        /**
         * This method compares ball1 and ball2 with volume of each ball
         * @param ball1, ball2 Balls to be compared by size of volume
         * @return 0 if ball1 has same volume as ball2, returns negative integer
         * if ball1 has smaller volume than ball2, returns positive integer if ball1
         * is has larger volume than ball2
         */
