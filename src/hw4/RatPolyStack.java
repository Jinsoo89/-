...
public final class RatPolyStack implements Iterable<RatPoly> {
    ...
    /**
     * Pops two elements off of the stack, adds them, and places the result on top
     * of the stack.
     *
     * @requires this.size() >= 2
     * @modifies this
    ...
    /**
     * Subtracts the top poly from the next from top poly, pops both off the stack,
    ...
    /**
     * Pops two elements off of the stack, multiplies them, and places the result on
     * top of the stack.
     *
     * @requires this.size() >= 2
     * @modifies this
    ...
    /**
     * Divides the next from top poly by the top poly, pops both off the stack, and
     ...
     * @modifies this
     * @effects If this = [p1]:S then this_post = [p2]:S where p2 = derivative of p1
     */
    ...
    /**
     * Pops the top element off of the stack, integrates it, and places the result
     * on top of the stack.
     *
     * @requires this.size() >= 1
     * @modifies this
     ...
     *
     * @return an iterator of the elements contained in the stack in order from the
     *         bottom of the stack to the top of the stack.
     */
    @Override
