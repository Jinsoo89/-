...
public final class RatTerm {
     ...
     *             if (this.expt != arg.expt) and neither argument is zero or NaN.
     */
     ...
     *         words, q is the derivative of this. If this.isNaN(), then return some
     *         q such that q.isNaN()
     *         <p>
     *         Given a term, a*x^b, the derivative of the term is: (a*b)*x^(b-1) for
     *         b > 0 and 0 for b == 0 (Do not worry about the case when b < 0. The
     *         caller of this function, RatPoly, contains a rep. invariant stating
     *         that b is never less than 0.)
     */
     ...
     *         antiderivative of this. If this.isNaN(), then return some q such that
     *         q.isNaN()
     *         <p>
     *         Given a term, a*x^b, (where b >= 0) the antiderivative of the term
     *         is: a/(b+1)*x^(b+1) (Do not worry about the case when b < 0. The
     *         caller of this function, RatPoly, contains a rep. invariant stating
     *         that b is never less than 0.)
     */
     ...
     *         {@link hw4.RatNum}'s toString method) and E is an integer. UNLESS:
     *         (1) the exponent E is zero, in which case T takes the form "C" (2)
     *         the exponent E is one, in which case T takes the form "C*x" (3) the
     *         coefficient C is one, in which case T takes the form "x^E" or "x" (if
     *         E is one) or "1" (if E is zero).
     *         <p>
     ...
     * @requires 'termStr' is an instance of a string with no spaces that expresses
     *           a RatTerm in the form defined in the toString() method.
     *           <p>
     *
